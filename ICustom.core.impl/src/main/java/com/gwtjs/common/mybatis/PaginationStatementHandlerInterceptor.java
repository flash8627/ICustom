package com.gwtjs.common.mybatis;
...
import com.gwtjs.common.dialect.Dialect;
import com.gwtjs.common.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor {
	 ...
	 * @throws Exception
	 */
	private int getTotal(ParameterHandler parameterHandler,
			Connection connection, String countSql) throws Exception {
