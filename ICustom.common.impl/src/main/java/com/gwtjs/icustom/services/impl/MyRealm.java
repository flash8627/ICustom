...
import com.gwtjs.icustom.dao.MyRealmUserDao;*/
...
public class MyRealm /*extends AuthorizingRealm*/ {
    ...
    /*@Inject
    private MyRealmUserDao myrealmUserDao;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        // 根据用户名查询出密码（已加密）
        String password = myrealmUserDao.queryPassword(username);
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        // 获取角色名集合
        Set<String> roleNameSet = myrealmUserDao.queryRoleNameSet(username);
        // 获取权限名集合
        Set<String> permissionNameSet = myrealmUserDao.queryPermissionNameSet(username);
        // 返回角色名集合与权限名集合封装的对象
