...
insert into SYS_REGISTER_T (REG_ID, REG_NAME, REG_CODE, REG_DESC, REG_VALUE, PARENT_PATH, PARENT_ID, ORDER_CODE, CREATED_USER, CREATED_DATE, UPDATE_LAST_USER, UPDATE_LAST_DATE, VALID_FLAG)
values (4, '测试1', 'config1', '测试1', 'regValue', 'config', 3, 1, 1, to_date(sysdate, 'dd-mm-yyyy hh24:mi:ss'), 1, to_date(sysdate, 'dd-mm-yyyy hh24:mi:ss'), 1);


insert into SYS_REGISTER_T (REG_ID, REG_NAME, REG_CODE, REG_DESC, REG_VALUE, PARENT_PATH, PARENT_ID, ORDER_CODE, CREATED_USER, CREATED_DATE, UPDATE_LAST_USER, UPDATE_LAST_DATE, VALID_FLAG)
values (6, 'i-custom', 'icostom', 'i-custom', '', '', 0, 1, 1, to_date(sysdate, 'dd-mm-yyyy hh24:mi:ss'), 1, to_date(sysdate, 'dd-mm-yyyy hh24:mi:ss'), 1);

insert into SYS_REGISTER_T (REG_ID, REG_NAME, REG_CODE, REG_DESC, REG_VALUE, PARENT_PATH, PARENT_ID, ORDER_CODE, CREATED_USER, CREATED_DATE, UPDATE_LAST_USER, UPDATE_LAST_DATE, VALID_FLAG)
values (8, 'i-custom', 'icostom', 'i-custom', '', 'icostom', 6, 1, 1, to_date(sysdate, 'dd-mm-yyyy hh24:mi:ss'), 1, to_date(sysdate, 'dd-mm-yyyy hh24:mi:ss'), 1);
